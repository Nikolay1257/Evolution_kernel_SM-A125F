 ...
 **************************************************/
#define SEG3_GPU_DVFS_FREQ0			(830000)	/* KHz */
#define SEG3_GPU_DVFS_FREQ1			(650000)	/* KHz */
#define SEG3_GPU_DVFS_FREQ2			(450000)	/* KHz */

#define SEG3_GPU_DVFS_VOLT0			(87500)		/* mV x 100 */
#define SEG3_GPU_DVFS_VOLT1			(77500)		/* mV x 100 */
#define SEG3_GPU_DVFS_VOLT2			(67500)		/* mV x 100 */
